...
function testAddNums() {
  assertEqual(addNums(5, 10), 15, "add positive Numbers");
  assertEqual(addNums(-5, 10), 5, "add negative Num + Positive");
  assertEqual(addNums("2", 10), 12, "Add a String with a Number");
  assertEqual(addNums("-1", "-4"), -5, "add two negative Strings");
}
